...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@535404235886559243> \n `Berdan Varol`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **17.01.2019**'de yapılmaya başlanmıştır")
    .setFooter('🌺Berdan🌺', client.user.avatarURL)
    .setTimestamp()
