...
exports.run = (client, message, params) => {
  var konum = ''
    ...
    .addField("» Linkler", `[Bot Davet Linki](https://discordapp.com/oauth2/authorize?client_id=535404235886559243&scope=bot&permissions=805314616` +  "**\n**"+`[Destek Sunucusu](https://discord.gg/7KRdpPm)`, false);
    console.log("?sunucubilgi komutu " + message.author.username + '#' + message.author.discriminator + " tarafından kullanıldı.")
